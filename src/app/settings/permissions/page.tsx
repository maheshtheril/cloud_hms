                                ...
                                <form onSubmit={handleCreate} className="space-y-6 mt-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {DEFAULT_MODULES.map(mod => (
                                            <div
                                                key={mod}
                                                onClick={() => setNewPermission({ ...newPermission, module: mod })}
                                                className={cn(
                                                    "cursor-pointer px-3 py-2 rounded-md border text-center text-sm transition-all",
                                                    newPermission.module === mod
