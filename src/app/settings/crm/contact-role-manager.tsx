        ...
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-medium">Contact Roles</h3>
                </div>
                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input value={name} onChange={e => setName(e.target.value)} required placeholder="e.g. Decision Maker, Influencer" />
                            </div>
                            <div className="space-y-2">
            ...
            <div className="border rounded-md">
                <Table>
                    ...
                    <TableBody>
                        {data.length === 0 ? (
                            <TableRow>
                                <TableCell colSpan={3} className="text-center text-gray-500">No contact roles defined.</TableCell>
                            </TableRow>
                        ) : (
                            data.map(item => (
