...
import { OrgChartView } from '@/components/crm/org-chart/org-chart-view'
import { GitGraph, Share2, Printer } from 'lucide-react'
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4 mt-2">
                                ...
                                <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px]">
                                    Hierarchy Visualization & Command Structure
                                </p>
                            </div>
                        </div>
                    </div>
