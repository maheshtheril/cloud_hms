            ...
            <div className="border-b border-white/5 bg-neutral-900/50 backdrop-blur-xl sticky top-0 z-40">
                <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-neutral-500 mt-1 font-medium">Manage incoming payments from customers</p>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-white/5 bg-white/[0.02]">
                                    ...
                                    <th className="py-4 px-6 text-xs font-medium text-neutral-500 uppercase tracking-wider">Payer / Customer</th>
                                ...
                                {filtered.map((receipt) => (
                                    <tr key={receipt.id} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="py-4 px-6">
                                            <div className="font-mono text-sm text-emerald-400 font-medium group-hover:text-emerald-300 transition-colors">
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="text-sm font-medium text-neutral-200">{receipt.partner_name}</div>
                                            {receipt.metadata?.memo && <div className="text-xs text-neutral-600 truncate max-w-[200px]">{receipt.metadata.memo}</div>}
                                        </td>
