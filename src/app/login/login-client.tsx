...
export default function LoginClient({ branding }: { branding: Branding | null }) {
    ...
    if (isLogin) {
        return (
            <div className="min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-50 via-slate-50 to-white dark:from-slate-950 dark:via-indigo-950/20 dark:to-slate-950 overflow-hidden relative">
