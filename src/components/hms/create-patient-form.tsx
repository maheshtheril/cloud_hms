...
export function CreatePatientForm() {
    ...
    return (
        <form action={action} className="max-w-5xl mx-auto space-y-8 pb-12">
            ...
            <div className="flex items-center justify-between sticky top-0 z-10 bg-white/80 backdrop-blur-md p-4 -mx-4 border-b border-gray-100">
                ...
                <div className="flex gap-3">
                    ...
                    <button type="submit" disabled={isPending} className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm flex items-center gap-2 shadow-sm disabled:opacity-70">
                        {isPending ? (
