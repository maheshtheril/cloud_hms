...
async function main() {
    // 1. Find a patient with "Dues" (positive balance from getPatientBalance logic)
    // We will mimic getPatientBalance logic manually for all patients? No, expensive.
    // Let's just find the last invoice that was "settled" or updated recently.
...
async function getPatientBalance(patientId, companyId) {
